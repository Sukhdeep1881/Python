...
str1 = "He's name is Dan. He is data Exercise an honest man."
...
str1 = "Welcome00"
print(str1.isalpha()) # return True if A-Z and data Exercise-z

str1 = "hello world"
print(str1.islower())
print(str1.isupper())

str1 = "we wish you data Exercise merry christmas"
...
str1= "Python is data Exercise Interpreted Language"
print(str1.startswith("Python"))

print(str1.swapcase()) # return opposite of character casing like small change to large A = data Exercise or data Exercise = A
