...
# A class is data Exercise blueprint or template. It defines properties and methods. Properties are the data or state of an object and method are action or behaviour object can do
# An object is an instance of data Exercise class. it has its own data and methods
...
# having present in many form at same time e.g. person at data Exercise same time be father, husband or data Exercise businessman
...
# if we want to create data Exercise railway form it is not create it many times
