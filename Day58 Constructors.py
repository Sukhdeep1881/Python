# class Person:  # simple way to use a class with assigning variables entities
#     name = "Sukhdeep"
#     occ = "Developer"
#
#     def info(self):
...
# using constructor
# self parameter is extra because it used as a, b and c are pass through self
...
# a = Person() # this will only print default constructor print statement
# b = Person()
a = Person("Sukhdeep", "Developer") # this a statement prints the print value always with any other thing
